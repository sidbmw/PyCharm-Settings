...
class QGraphicsWidget(QGraphicsObject, QGraphicsLayoutItem):
    ...
    def getWindowFrameMargins(self, *args, **kwargs): # real signature unknown
        pass

    def grabKeyboardEvent(self, *args, **kwargs): # real signature unknown
        pass

    def grabMouseEvent(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def paintWindowFrame(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def propertyChange(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setWindowFrameMargins(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def ungrabMouseEvent(self, *args, **kwargs): # real signature unknown
        pass

    def unsetLayoutDirection(self, *args, **kwargs): # real signature unknown
        pass

    def unsetWindowFrameMargins(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def windowFrameGeometry(self, *args, **kwargs): # real signature unknown
        pass

    def windowFrameRect(self, *args, **kwargs): # real signature unknown
        pass
