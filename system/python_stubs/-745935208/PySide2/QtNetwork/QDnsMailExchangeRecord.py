...
class QDnsMailExchangeRecord(__Shiboken.Object):
    # no doc
    def exchange(self, *args, **kwargs): # real signature unknown
        pass

    def name(self, *args, **kwargs): # real signature unknown
        pass

    def preference(self, *args, **kwargs): # real signature unknown
        pass

    def swap(self, *args, **kwargs): # real signature unknown
        pass

    def timeToLive(self, *args, **kwargs): # real signature unknown
        pass
