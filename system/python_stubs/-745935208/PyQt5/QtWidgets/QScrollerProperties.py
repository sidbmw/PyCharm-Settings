...
class QScrollerProperties(__sip.simplewrapper):
    """
    QScrollerProperties()
    QScrollerProperties(QScrollerProperties)
    """
    def scrollMetric(self, QScrollerProperties_ScrollMetric): # real signature unknown; restored from __doc__
        """ scrollMetric(self, QScrollerProperties.ScrollMetric) -> Any """
        pass

    def setDefaultScrollerProperties(self, QScrollerProperties): # real signature unknown; restored from __doc__
        """ setDefaultScrollerProperties(QScrollerProperties) """
        pass

    def setScrollMetric(self, QScrollerProperties_ScrollMetric, Any): # real signature unknown; restored from __doc__
        """ setScrollMetric(self, QScrollerProperties.ScrollMetric, Any) """
        pass

    def unsetDefaultScrollerProperties(self): # real signature unknown; restored from __doc__
    ...
    def __init__(self, QScrollerProperties=None): # real signature unknown; restored from __doc__ with multiple overloads
        pass
