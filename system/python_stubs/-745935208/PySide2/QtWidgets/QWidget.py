...
class QWidget(__PySide2_QtCore.QObject, __PySide2_QtGui.QPaintDevice):
    ...
    def backingStore(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def createWindowContainer(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def hasTabletTracking(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def internalWinId(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def isEnabledToTLW(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def isTopLevel(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setTabletTracking(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setToolTipDuration(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setWindowFlag(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def toolTipDuration(self, *args, **kwargs): # real signature unknown
        pass

    def topLevelWidget(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def windowHandle(self, *args, **kwargs): # real signature unknown
        pass
    ...
    DrawChildren = None # (!) real value is ''
    DrawWindowBackground = None # (!) real value is ''
    IgnoreMask = None # (!) real value is ''
    RenderFlag = None # (!) real value is ''
    RenderFlags = None # (!) real value is ''
