...
# from C:\Users\siddh\AppData\Local\Programs\Python\Python37\lib\site-packages\lxml\_elementpath.cp37-win_amd64.pyd
# by generator 1.146
# no doc
...
ops = {
    '': None, # (!) forward: prepare_child, real value is ''
    '*': None, # (!) forward: prepare_star, real value is ''
    '.': None, # (!) forward: prepare_self, real value is ''
    '..': None, # (!) forward: prepare_parent, real value is ''
    '//': None, # (!) forward: prepare_descendant, real value is ''
    '[': None, # (!) forward: prepare_predicate, real value is ''
}
