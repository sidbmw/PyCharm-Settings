...
class QPyTextObject(__PySide2_QtCore.QObject, QTextObjectInterface):
    # no doc
    def drawObject(self, *args, **kwargs): # real signature unknown
        pass

    def intrinsicSize(self, *args, **kwargs): # real signature unknown
        pass
