...
class QPlaceSupplier(__sip.simplewrapper):
    ...
    def setSupplierId(self, p_str): # real signature unknown; restored from __doc__
        """ setSupplierId(self, str) """
        pass
    ...
    def __init__(self, QPlaceSupplier=None): # real signature unknown; restored from __doc__ with multiple overloads
        pass
