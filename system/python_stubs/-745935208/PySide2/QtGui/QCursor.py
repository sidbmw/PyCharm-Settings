...
class QCursor(__Shiboken.Object):
    # no doc
    def bitmap(self, *args, **kwargs): # real signature unknown
        pass

    def hotSpot(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setShape(self, *args, **kwargs): # real signature unknown
        pass
