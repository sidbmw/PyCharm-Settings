...
class QAccessibleTextUpdateEvent(QAccessibleTextCursorEvent):
    # no doc
    def changePosition(self, *args, **kwargs): # real signature unknown
        pass

    def textInserted(self, *args, **kwargs): # real signature unknown
        pass

    def textRemoved(self, *args, **kwargs): # real signature unknown
        pass
