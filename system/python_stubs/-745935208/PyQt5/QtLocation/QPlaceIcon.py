...
class QPlaceIcon(__sip.simplewrapper):
    """
    QPlaceIcon()
    ...
    def setManager(self, QPlaceManager): # real signature unknown; restored from __doc__
        """ setManager(self, QPlaceManager) """
        pass
    ...
    def url(self, size=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ url(self, size: QSize = QSize()) -> QUrl """
        pass
    ...
    def __init__(self, QPlaceIcon=None): # real signature unknown; restored from __doc__ with multiple overloads
        pass
