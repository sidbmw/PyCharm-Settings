...
class QGraphicsEllipseItem(QAbstractGraphicsShapeItem):
    ...
    def setSpanAngle(self, *args, **kwargs): # real signature unknown
        pass

    def setStartAngle(self, *args, **kwargs): # real signature unknown
        pass

    def shape(self, *args, **kwargs): # real signature unknown
        pass

    def spanAngle(self, *args, **kwargs): # real signature unknown
        pass

    def startAngle(self, *args, **kwargs): # real signature unknown
        pass
