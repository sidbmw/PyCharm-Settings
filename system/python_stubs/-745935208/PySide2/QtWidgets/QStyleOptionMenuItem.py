...
class QStyleOptionMenuItem(QStyleOption):
    ...
    DefaultItem = None # (!) real value is ''
    EmptyArea = None # (!) real value is ''
    Exclusive = None # (!) real value is ''
    Margin = None # (!) real value is ''
    MenuItemType = None # (!) real value is ''
    NonExclusive = None # (!) real value is ''
    Normal = None # (!) real value is ''
    NotCheckable = None # (!) real value is ''
    Scroller = None # (!) real value is ''
    Separator = None # (!) real value is ''
    StyleOptionType = None # (!) real value is ''
    StyleOptionVersion = None # (!) real value is ''
    SubMenu = None # (!) real value is ''
    TearOff = None # (!) real value is ''
