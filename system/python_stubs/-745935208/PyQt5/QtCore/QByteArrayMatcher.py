...
class QByteArrayMatcher(__sip.simplewrapper):
    """
    QByteArrayMatcher()
    QByteArrayMatcher(Union[QByteArray, bytes, bytearray])
    QByteArrayMatcher(QByteArrayMatcher)
    """
    def indexIn(self, Union, QByteArray=None, bytes=None, bytearray=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    ...
    def setPattern(self, Union, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__
