...
class QStyleOptionComboBox(QStyleOptionComplex):
    ...
    currentIcon = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    currentText = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    iconSize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    popupRect = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
