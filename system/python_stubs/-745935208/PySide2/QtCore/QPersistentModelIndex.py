...
class QPersistentModelIndex(__Shiboken.Object):
    # no doc
    ...
    def internalId(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def sibling(self, *args, **kwargs): # real signature unknown
        pass
