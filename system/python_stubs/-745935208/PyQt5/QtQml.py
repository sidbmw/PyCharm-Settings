# encoding: utf-8
# module PyQt5.QtQml
# from C:\Users\siddh\AppData\Local\Programs\Python\Python37\lib\site-packages\PyQt5\QtQml.pyd
# by generator 1.146
# no doc
...
def qmlRegisterSingletonType(QUrl, p_str, p_int, p_int_1, p_str_1): # real signature unknown; restored from __doc__
    ...
    qmlRegisterSingletonType(type, str, int, int, str, Callable[[], Any]) -> int
    """
    return 0
