...
class QSslDiffieHellmanParameters(__Shiboken.Object):
    # no doc
    def defaultParameters(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def fromEncoded(self, *args, **kwargs): # real signature unknown
        pass
    ...
    InvalidInputDataError = None # (!) real value is ''
    NoError = None # (!) real value is ''
    UnsafeParametersError = None # (!) real value is ''
    __hash__ = None
