...
class QPagedPaintDevice(QPaintDevice):
    ...
    def pageLayout(self): # real signature unknown; restored from __doc__
    ...
    def pageSizeMM(self): # real signature unknown; restored from __doc__
    ...
    def setPageLayout(self, QPageLayout): # real signature unknown; restored from __doc__
        """ setPageLayout(self, QPageLayout) -> bool """
        return False

    def setPageMargins(self, QMarginsF, QPageLayout_Unit=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def setPageOrientation(self, QPageLayout_Orientation): # real signature unknown; restored from __doc__
