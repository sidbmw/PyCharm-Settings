...
class QTextObject(__PySide2_QtCore.QObject):
    # no doc
    ...
    def formatIndex(self, *args, **kwargs): # real signature unknown
        pass

    def objectIndex(self, *args, **kwargs): # real signature unknown
        pass
