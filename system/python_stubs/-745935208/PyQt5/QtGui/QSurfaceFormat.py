...
class QSurfaceFormat(__sip.simplewrapper):
    ...
    def setColorSpace(self, QSurfaceFormat_ColorSpace): # real signature unknown; restored from __doc__
    ...
    def setOptions(self, Union, QSurfaceFormat_FormatOptions=None, QSurfaceFormat_FormatOption=None): # real signature unknown; restored from __doc__
