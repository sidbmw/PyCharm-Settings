...
def qAlpha(QRgba64): # real signature unknown; restored from __doc__
    """
    qAlpha(QRgba64) -> int
    qAlpha(int) -> int
    """
...
def qBlue(QRgba64): # real signature unknown; restored from __doc__
    """
    qBlue(QRgba64) -> int
    qBlue(int) -> int
    """
...
def qFuzzyCompare(QMatrix4x4, QMatrix4x4_1): # real signature unknown; restored from __doc__
    """
...
def qGreen(QRgba64): # real signature unknown; restored from __doc__
    """
    qGreen(QRgba64) -> int
    qGreen(int) -> int
    """
...
def qPixelFormatAlpha(p_int, typeInterpretation=None): # real signature unknown; restored from __doc__
    """ qPixelFormatAlpha(int, typeInterpretation: QPixelFormat.TypeInterpretation = QPixelFormat.UnsignedInteger) -> QPixelFormat """
    return QPixelFormat

def qPixelFormatCmyk(p_int, alphaSize=0, alphaUsage=None, alphaPosition=None, typeInterpretation=None): # real signature unknown; restored from __doc__
...
def qPixelFormatGrayscale(p_int, typeInterpretation=None): # real signature unknown; restored from __doc__
    """ qPixelFormatGrayscale(int, typeInterpretation: QPixelFormat.TypeInterpretation = QPixelFormat.UnsignedInteger) -> QPixelFormat """
    return QPixelFormat

def qPixelFormatHsl(p_int, alphaSize=0, alphaUsage=None, alphaPosition=None, typeInterpretation=None): # real signature unknown; restored from __doc__
...
def qPixelFormatHsv(p_int, alphaSize=0, alphaUsage=None, alphaPosition=None, typeInterpretation=None): # real signature unknown; restored from __doc__
...
def qPixelFormatRgba(p_int, p_int_1, p_int_2, p_int_3, QPixelFormat_AlphaUsage, QPixelFormat_AlphaPosition, premultiplied=None, typeInterpretation=None): # real signature unknown; restored from __doc__
...
def qPixelFormatYuv(QPixelFormat_YUVLayout, alphaSize=0, alphaUsage=None, alphaPosition=None, premultiplied=None, typeInterpretation=None, byteOrder=None): # real signature unknown; restored from __doc__
...
def qPremultiply(QRgba64): # real signature unknown; restored from __doc__
    """
...
def qRed(QRgba64): # real signature unknown; restored from __doc__
    """
    qRed(QRgba64) -> int
    qRed(int) -> int
    """
...
def qRgba64(p_int, p_int_1, p_int_2, p_int_3): # real signature unknown; restored from __doc__
    """
...
def qt_set_sequence_auto_mnemonic(bool): # real signature unknown; restored from __doc__
    """ qt_set_sequence_auto_mnemonic(bool) """
    pass

def qUnpremultiply(QRgba64): # real signature unknown; restored from __doc__
    """
