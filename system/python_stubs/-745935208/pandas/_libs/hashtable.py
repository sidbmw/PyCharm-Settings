...
# from C:\Users\siddh\AppData\Local\Programs\Python\Python37\lib\site-packages\pandas\_libs\hashtable.cp37-win_amd64.pyd
# by generator 1.146
# no doc
...
class Float64HashTable(HashTable):
    ...
    def unique_memview(self, *args, **kwargs): # real signature unknown
        pass
...
__test__ = {
    'Factorizer.factorize (line 71)': "\n        Factorize values with nans replaced by na_sentinel\n        >>> factorize(np.array([1,2,np.nan], dtype='O'), na_sentinel=20)\n        array([ 0,  1, 20])\n        ",
    'Int64Factorizer.factorize (line 115)': "\n        Factorize values with nans replaced by na_sentinel\n        >>> factorize(np.array([1,2,np.nan], dtype='O'), na_sentinel=20)\n        array([ 0,  1, 20])\n        ",
}
