...
# from C:\Users\siddh\AppData\Local\Programs\Python\Python37\lib\site-packages\PyQt5\QtWebEngineCore.pyd
# by generator 1.146
# no doc
...
class QWebEngineCookieStore(__PyQt5_QtCore.QObject):
    ...
    def setCookieFilter(self, filterCallback, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setCookieFilter(self, filterCallback: Callable[[], bool] = 0) """
        pass
