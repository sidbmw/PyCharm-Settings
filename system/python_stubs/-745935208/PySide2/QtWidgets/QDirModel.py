...
class QDirModel(__PySide2_QtCore.QAbstractItemModel):
    ...
    def fileIcon(self, *args, **kwargs): # real signature unknown
        pass

    def fileInfo(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def lazyChildCount(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setLazyChildCount(self, *args, **kwargs): # real signature unknown
        pass
    ...
    FileIconRole = None # (!) real value is ''
    FileNameRole = None # (!) real value is ''
    FilePathRole = None # (!) real value is ''
