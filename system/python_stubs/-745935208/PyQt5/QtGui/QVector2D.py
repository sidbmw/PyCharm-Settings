...
class QVector2D(__sip.simplewrapper):
    """
    QVector2D()
    ...
    QVector2D(QVector2D)
    """
    def distanceToLine(self, QVector2D, QVector2D_1): # real signature unknown; restored from __doc__
        """ distanceToLine(self, QVector2D, QVector2D) -> float """
        return 0.0

    def distanceToPoint(self, QVector2D): # real signature unknown; restored from __doc__
