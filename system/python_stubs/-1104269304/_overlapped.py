# encoding: utf-8
# module _overlapped
# from C:\Users\siddh\AppData\Local\Programs\Python\Python37-32\DLLs\_overlapped.pyd
# by generator 1.145
# no doc
# no imports
...
class Overlapped(object):
    ...
    def ReadFileInto(self, handle, buf): # real signature unknown; restored from __doc__
        """
    ...
    def TransmitFile(self, socket, file, offset, offset_high, count_to_write, count_per_send, flags): # real signature unknown; restored from __doc__
        """
    ...
    def WSARecvInto(self, handle, buf, flags): # real signature unknown; restored from __doc__
        """
