...
class QStaticText(__sip.simplewrapper):
    ...
    def setPerformanceHint(self, QStaticText_PerformanceHint): # real signature unknown; restored from __doc__
    ...
    def swap(self, QStaticText): # real signature unknown; restored from __doc__
