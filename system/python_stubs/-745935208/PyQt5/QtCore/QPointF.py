...
class QPointF(__sip.simplewrapper):
    """
    QPointF()
    QPointF(float, float)
    QPointF(QPoint)
    QPointF(QPointF)
    """
    def dotProduct(self, Union, QPointF=None, QPoint=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
