...
class QStyleHints(__PyQt5_QtCore.QObject):
    ...
    def cursorFlashTimeChanged(self, p_int): # real signature unknown; restored from __doc__
    ...
    def keyboardInputIntervalChanged(self, p_int): # real signature unknown; restored from __doc__
    ...
    def mouseDoubleClickIntervalChanged(self, p_int): # real signature unknown; restored from __doc__
    ...
    def mousePressAndHoldIntervalChanged(self, p_int): # real signature unknown; restored from __doc__
    ...
    def mouseQuickSelectionThresholdChanged(self, p_int): # real signature unknown; restored from __doc__
    ...
    def setUseHoverEffects(self, bool): # real signature unknown; restored from __doc__
    ...
    def startDragDistanceChanged(self, p_int): # real signature unknown; restored from __doc__
    ...
    def startDragTimeChanged(self, p_int): # real signature unknown; restored from __doc__
    ...
    def tabFocusBehaviorChanged(self, Qt_TabFocusBehavior): # real signature unknown; restored from __doc__
    ...
    def useHoverEffectsChanged(self, bool): # real signature unknown; restored from __doc__
    ...
    def wheelScrollLinesChanged(self, p_int): # real signature unknown; restored from __doc__
