...
class QSize(__Shiboken.Object):
    # no doc
    def boundedTo(self, *args, **kwargs): # real signature unknown
        pass

    def expandedTo(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def scaled(self, *args, **kwargs): # real signature unknown
        pass
