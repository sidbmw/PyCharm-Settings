...
# from C:\Users\siddh\AppData\Local\Programs\Python\Python37\lib\site-packages\pandas\_libs\tslibs\frequencies.cp37-win_amd64.pyd
# by generator 1.146
# no doc
...
__pyx_capi__ = {
    'get_base_alias': None, # (!) real value is ''
    'get_freq': None, # (!) real value is ''
    'get_freq_code': None, # (!) real value is ''
    'get_freq_str': None, # (!) real value is ''
    'get_rule_month': None, # (!) real value is ''
    'get_to_timestamp_base': None, # (!) real value is ''
}
