...
class QScrollPrepareEvent(__PyQt5_QtCore.QEvent):
    """
    ...
    def contentPosRange(self): # real signature unknown; restored from __doc__
        """ contentPosRange(self) -> QRectF """
        pass

    def setContentPos(self, Union, QPointF=None, QPoint=None): # real signature unknown; restored from __doc__
        """ setContentPos(self, Union[QPointF, QPoint]) """
        pass

    def setContentPosRange(self, QRectF): # real signature unknown; restored from __doc__
        """ setContentPosRange(self, QRectF) """
        pass

    def setViewportSize(self, QSizeF): # real signature unknown; restored from __doc__
        """ setViewportSize(self, QSizeF) """
        pass

    def startPos(self): # real signature unknown; restored from __doc__
