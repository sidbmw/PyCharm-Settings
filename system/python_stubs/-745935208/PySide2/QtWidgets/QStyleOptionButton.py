...
class QStyleOptionButton(QStyleOption):
    ...
    AutoDefaultButton = None # (!) real value is ''
    ButtonFeature = None # (!) real value is ''
    ButtonFeatures = None # (!) real value is ''
    CommandLinkButton = None # (!) real value is ''
    DefaultButton = None # (!) real value is ''
    Flat = None # (!) real value is ''
    HasMenu = None # (!) real value is ''
